...
describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    ...
    it('negative and the positive numbers', () => {
  ...
  describe('type == "DIVIDE"', () => {
    ...
    it('the positive number and 0', () => {
      expect(calculateNumber('DIVIDE', 5.0, 0)).to.equal('Error');
    });

    it('the positive number and number rounded down to 0', () => {
      expect(calculateNumber('DIVIDE', 5.0, 0.2)).to.equal('Error');
    });

    it('the positive number and number rounded up to 0', () => {
      expect(calculateNumber('DIVIDE', 5.0, -0.2)).to.equal('Error');
    });
